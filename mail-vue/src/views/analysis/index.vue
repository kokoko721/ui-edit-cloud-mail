...
const topic = computed(() => ({
  ...
  background: '#1b1d22',
  borderColor: '#17181c',
  scaleLineColor: '#31353d',
  crossColor: '#aeb4bf',
  axisColor: '#4a4f59',
  splitLineColor: '#31353d',
  gaugeSplitLine: '#c5c6d0',
  containerBackground: '#2c3038'
}))
let daySendTotal = 0
let leaveWidth = 0
let senderPie = null
    ...
    series: [
      {
        ...
        color: ['#adc6ff', '#13deb9', '#ffb86b', '#ff8a80', '#7bd88f', '#c084fc']
      }
    ]
  }
    ...
    series: [
      {
        ...
        areaStyle: {
          color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [
            {
              offset: 0,
              color: 'rgba(173, 198, 255, 0.3)'
            },
            {
              offset: 1,
              color: 'rgba(173, 198, 255, 0.03)'
            }
          ])
        },
        color: ['#adc6ff'],
